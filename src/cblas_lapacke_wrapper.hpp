...
template <class Real>
inline eigen_mathlib_int stedc(char compz, eigen_mathlib_int n, Real *d,
                               Real *e, Real *z, eigen_mathlib_int ldz,
                               Real *work, int64_t lwork,
                               eigen_mathlib_int *iwork,
                               eigen_mathlib_int liwork);

template <>
inline eigen_mathlib_int stedc<double>(char compz, eigen_mathlib_int n,
                                       double *d, double *e, double *z,
                                       eigen_mathlib_int ldz, double *work,
                                       int64_t lwork, eigen_mathlib_int *iwork,
                                       eigen_mathlib_int liwork) {
...
template <>
inline eigen_mathlib_int stedc<float>(char compz, eigen_mathlib_int n, float *d,
                                      float *e, float *z, eigen_mathlib_int ldz,
...
template <>
inline eigen_mathlib_int lascl<double>(char type, eigen_mathlib_int kl,
                                       eigen_mathlib_int ku, double cfrom,
                                       double cto, eigen_mathlib_int m,
                                       eigen_mathlib_int n, double *a,
...
template <>
inline eigen_mathlib_int lascl<float>(char type, eigen_mathlib_int kl,
                                      eigen_mathlib_int ku, float cfrom,
                                      float cto, eigen_mathlib_int m,
                                      eigen_mathlib_int n, float *a,
                                      eigen_mathlib_int lda) {
  eigen_mathlib_int info = 0;
...
template <class Real>
inline Real lapy2(Real x, Real y);
...
inline void gemm<double>(const CBLAS_TRANSPOSE TransA,
                         ...
                         const eigen_mathlib_int M, const eigen_mathlib_int N,
                         const eigen_mathlib_int K, const double alpha,
                         const double *A, const eigen_mathlib_int lda,
                         const double *B, const eigen_mathlib_int ldb,
...
template <class Real>
inline Real lamc3(Real x, Real y);
